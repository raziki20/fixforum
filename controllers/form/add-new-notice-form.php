<form action="components/add-new-notice.php" method="post" enctype="multipart/form-data" id="UploadForm">
    ...
    <div class="form-group">
        ...
        <br>
        <label class="radio-inline" for="kategori-inline-radio1"><input type="radio" id="kategori-inline-radio1" name="notice_topic_kategori[]" value="1"> Tari Tradisional </label>
        <label class="radio-inline" for="kategori-inline-radio2"><input type="radio" id="kategori-inline-radio2" name="notice_topic_kategori[]" value="2"> Tari Modern </label>

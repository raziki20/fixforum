<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql="INSERT INTO forum_topic(forum_topic_name, forum_topic_body, forum_topic_time, forum_topic_created_by, forum_topic_kategori, forum_topic_image) VALUES ('$forum_topic_name', '$forum_topic_body', CURRENT_TIMESTAMP, '$user_username' ,'$forum_topic_kategori', '$BackgroundNewImageName')";

<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql="INSERT INTO notice_topic(notice_topic_name, notice_topic_body, notice_topic_time, notice_topic_created_by, notice_topic_kategori) VALUES ('$notice_topic_name', '$notice_topic_body', CURRENT_TIMESTAMP, '$user_username' ,'$notice_topic_kategori')";
